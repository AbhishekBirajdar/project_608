...
from src.schemas.sections_schemas import ResumeSchema
from src.utils import utils
from src.utils.latex_ops import latex_to_pdf
from src.utils.llm_models import ChatGPT, Gemini, OllamaModel
from src.utils.data_extraction import read_data_from_url, extract_text
from src.utils.metrics import jaccard_similarity, overlap_coefficient, cosine_similarity, vector_embedding_similarity
from src.prompts.resume_prompt import CV_GENERATOR, RESUME_WRITER_PERSONA, JOB_DETAILS_EXTRACTOR, RESUME_DETAILS_EXTRACTOR
from src.schemas.job_details_schema import JobDetails
from src.variables import DEFAULT_LLM_MODEL, DEFAULT_LLM_PROVIDER, LLM_MAPPING, section_mapping

module_dir = os.path.dirname(__file__)
demo_data_path = os.path.join(module_dir, "demo_data", "user_profile.json")
prompt_path = os.path.join(module_dir, "prompts")

##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
